const CarouselCard = ({ data }) => {
    return (
        <div className="bg-gradient-to-br from-white2 to-white shadow-md rounded-md text-center mr-2 max-w-lg">
            <div
        ...
        style={{ backgroundImage: `url(${data.img})`, width: '100%', height: '100%' }}
            ...
            <div className="p-6">
                <h4 className="text-lg font-medium text-grey">{data.title}</h4>
